...
$ExtractDir = Join-Path $DownloadDir "llamacpp-rocm"
...
& "$HOME\apps\llamacpp-rocm\llama-server.exe" --version

Write-Host "✔️  Updating Llama.cpp compiled for the ROCm backend complete" -ForegroundColor Cyan